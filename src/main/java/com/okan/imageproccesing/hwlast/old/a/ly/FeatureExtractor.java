package com.okan.imageproccesing.hwlast.old.a.ly;

import com.okan.imageproccesing.hwlast.util.ConvexHull;
import com.okan.imageproccesing.hwlast.util.Hog;
...
public class FeatureExtractor {
		...
		try{
			...
			for(int i = 0; i < classNames.length; i++){
				...
				for(int j = 1; j <= 10; j++){
					...
					double[] feature = oznitelikHesapla(img,pw);
			...
			for(int i = 0; i < classNames.length; i++){
				...
				for(int j = 11; j <= 20; j++){
					...
					double[] feature = oznitelikHesapla(img,pw2);
	...
	private static double[] oznitelikHesapla(Image img,PrintWriter pw){
