 ...
 * @author Erhan
 */
public class FeatureExtractorWithSobel {
    public static void main(String[] args) {
        ...
        try {
            // eğitim kümesi
            PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter("train_demo_sobel.arff")));
            ...
            // sinama kümesi
            PrintWriter pw2 = new PrintWriter(new BufferedWriter(new FileWriter("test_demo_sobel.arff")));
